...
/// struct for typed errors of method [`get_update_status`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetUpdateStatusError {
    Status400(),
...
/// struct for typed errors of method [`update_perform_fw`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UpdatePerformFwError {
    Status400(),
    UnknownValue(serde_json::Value),
}
...
pub async fn get_update_status(
...
) -> Result<models::GetUpdateStatus200Response, Error<GetUpdateStatusError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetUpdateStatusError> =
...
pub async fn restart(
    configuration: &configuration::Configuration,
    x_connection_key: &str,
    restart_request: Option<models::RestartRequest>,
) -> Result<models::SetHampVelocityPercent200Response, Error<RestartError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/maintenance/restart", local_var_configuration.base_path);
    let mut local_var_req_builder =
    ...
    local_var_req_builder =
        local_var_req_builder.header("X-Connection-Key", x_connection_key.to_string());
    local_var_req_builder = local_var_req_builder.json(&restart_request);
...
pub async fn update_perform_fw(
    configuration: &configuration::Configuration,
    x_connection_key: &str,
    update_perform: models::UpdatePerform,
) -> Result<models::SetHampVelocityPercent200Response, Error<UpdatePerformFwError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.header("X-Connection-Key", x_connection_key.to_string());
    local_var_req_builder = local_var_req_builder.json(&update_perform);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdatePerformFwError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
