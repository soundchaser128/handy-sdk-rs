...
pub struct GetHsspState200ResponseOneOf {
    #[serde(rename = "result")]
    pub result: models::GenericResult,
    #[serde(rename = "state")]
    pub state: models::HsspState,
}

impl GetHsspState200ResponseOneOf {
    pub fn new(
        result: models::GenericResult,
        state: models::HsspState,
    ) -> GetHsspState200ResponseOneOf {
        GetHsspState200ResponseOneOf { result, state }
    }
}
