...
/// GenericResult : Generic result values.<ul><li>SUCCESS(0)</li><li>ERROR(-1)</li></ul>
...
impl ToString for GenericResult {
...
impl Default for GenericResult {
    fn default() -> GenericResult {
        Self::SUCCESS
    }
}
