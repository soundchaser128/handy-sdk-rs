...
/// Mode : Available device modes.<ul><li>HAMP(0)<li>HSSP(1)</li><li>HDSP(2)</li><li>MAINTENANCE(3)</li><li>HBSP(4)</li></ul>
...
impl ToString for Mode {
    fn to_string(&self) -> String {
        match self {
            Self::HAMP => String::from("0"),
            Self::HSSP => String::from("1"),
            Self::HDSP => String::from("2"),
            Self::MAINTENANCE => String::from("3"),
            Self::HBSP => String::from("4"),
        }
    }
}
