...
/// HampModeErrors : The different possible HAMP mode specific error codes. <p> <ul> <li>ERROR(3000) - Unspecified HAMP error</li> </ul>
/// The different possible HAMP mode specific error codes. <p> <ul> <li>ERROR(3000) - Unspecified HAMP error</li> </ul>
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum HampModeErrors {
    #[serde(rename = "3000")]
    ERROR,
}

impl ToString for HampModeErrors {
    fn to_string(&self) -> String {
        match self {
            Self::ERROR => String::from("3000"),
        }
    }
}

impl Default for HampModeErrors {
    fn default() -> HampModeErrors {
        Self::ERROR
    }
}
