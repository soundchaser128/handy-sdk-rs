...
impl ToString for BaseModeErrors {
    fn to_string(&self) -> String {
        match self {
            Self::Error => String::from("2000"),
            Self::InvalidRequest => String::from("2001"),
            Self::MethodNotFound => String::from("2002"),
        }
    }
}

impl Default for BaseModeErrors {
    fn default() -> BaseModeErrors {
        Self::Error
    }
}
