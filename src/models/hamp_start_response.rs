...
pub struct HampStartResponse {
    #[serde(rename = "result")]
    pub result: models::StateResult,
}

impl HampStartResponse {
    pub fn new(result: models::StateResult) -> HampStartResponse {
        HampStartResponse { result }
    }
}
