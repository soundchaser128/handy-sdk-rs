...
pub struct PositionAbsoluteResponse {
    #[serde(rename = "result")]
...
impl PositionAbsoluteResponse {
    pub fn new(result: models::GenericResult, position: f64) -> PositionAbsoluteResponse {
        PositionAbsoluteResponse { result, position }
    }
}
