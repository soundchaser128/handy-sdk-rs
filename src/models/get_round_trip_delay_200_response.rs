...
#[serde(untagged)]
pub enum GetRoundTripDelay200Response {
    ErrorResponse(Box<models::ErrorResponse>),
    GetRoundTripDelay200ResponseOneOf(Box<models::GetRoundTripDelay200ResponseOneOf>),
}

impl Default for GetRoundTripDelay200Response {
    fn default() -> Self {
        Self::ErrorResponse(Default::default())
    }
}
