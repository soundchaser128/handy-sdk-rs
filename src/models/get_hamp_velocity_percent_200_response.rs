...
#[serde(untagged)]
pub enum GetHampVelocityPercent200Response {
    ErrorResponse(Box<models::ErrorResponse>),
    HampVelocityPercentResponse(Box<models::HampVelocityPercentResponse>),
}

impl Default for GetHampVelocityPercent200Response {
    fn default() -> Self {
