...
pub struct GetMode200ResponseOneOf {
    #[serde(rename = "result")]
...
impl GetMode200ResponseOneOf {
    pub fn new(result: models::GenericResult, mode: models::Mode) -> GetMode200ResponseOneOf {
        GetMode200ResponseOneOf { result, mode }
    }
}
