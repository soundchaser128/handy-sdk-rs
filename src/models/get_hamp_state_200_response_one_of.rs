...
pub struct GetHampState200ResponseOneOf {
    #[serde(rename = "result")]
    pub result: models::GenericResult,
    #[serde(rename = "state")]
    pub state: models::HampState,
}

impl GetHampState200ResponseOneOf {
    pub fn new(
        result: models::GenericResult,
        state: models::HampState,
    ) -> GetHampState200ResponseOneOf {
        GetHampState200ResponseOneOf { result, state }
    }
}
