...
/// FirmwareStatus : Possible device firmware status. <p> <ul> <li>0 - UP_TO_DATE - The firmware is up-tp-date (latest version).</li> <li>1 - UPDATE_REQUIRED - A critical update is available.</li> <li>2 - UPDATE_AVAILABLE - An non critical update to the firmware is available.</li> </ul>
...
impl ToString for FirmwareStatus {
    fn to_string(&self) -> String {
        match self {
            Self::UpToDate => String::from("0"),
            Self::UpdateRequired => String::from("1"),
            Self::UpdateAvailable => String::from("2"),
        }
    }
}
