...
/// HampState : Possible HAMP states: <ul> <li>STOPPED(1) - The device slide is not moving.</li> <li>MOVING(2) - The device slide is moving</li> </ul>
...
impl ToString for HampState {
    fn to_string(&self) -> String {
        match self {
            Self::STOPPED => String::from("1"),
            Self::MOVING => String::from("2"),
        }
    }
}

impl Default for HampState {
    fn default() -> HampState {
        Self::STOPPED
    }
}
