...
/// SlideResult : Possible slide operation result codes. <ul> <li>ACCEPTED(0) - Value updated.</li> <li>ACCEPTED_ROUNDED_DOWN(1) - Value updated but rounded down.</li> <li>ACCEPTED_ROUNDED_UP(2) - Value updated but rounded up.</li> </ul>
...
impl ToString for SlideResult {
    fn to_string(&self) -> String {
        match self {
            Self::Accepted => String::from("0"),
            Self::AcceptedRoundedDown => String::from("1"),
            Self::AcceptedRoundedUp => String::from("2"),
        }
    }
}

impl Default for SlideResult {
    fn default() -> SlideResult {
        Self::Accepted
    }
}
