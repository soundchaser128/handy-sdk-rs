...
pub struct Setup200ResponseOneOf {
    #[serde(rename = "result")]
    pub result: models::HsspSetupResult,
}

impl Setup200ResponseOneOf {
    pub fn new(result: models::HsspSetupResult) -> Setup200ResponseOneOf {
        Setup200ResponseOneOf { result }
    }
}
