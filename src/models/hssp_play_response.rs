...
/// HsspPlayResponse : The response returned from a hssp/play operation.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct HsspPlayResponse {
    #[serde(rename = "result")]
    pub result: models::HsspPlayResult,
}

impl HsspPlayResponse {
    /// The response returned from a hssp/play operation.
    pub fn new(result: models::HsspPlayResult) -> HsspPlayResponse {
        HsspPlayResponse { result }
    }
}
