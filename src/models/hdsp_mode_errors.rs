...
/// HdspModeErrors : The different possible HDSP mode specific error codes. <p> <ul> <li>ERROR(5000) - Unspecified HDSP error</li> </ul>
/// The different possible HDSP mode specific error codes. <p> <ul> <li>ERROR(5000) - Unspecified HDSP error</li> </ul>
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum HdspModeErrors {
    #[serde(rename = "5000")]
    ERROR,
}

impl ToString for HdspModeErrors {
    fn to_string(&self) -> String {
        match self {
            Self::ERROR => String::from("5000"),
        }
    }
}

impl Default for HdspModeErrors {
    fn default() -> HdspModeErrors {
        Self::ERROR
    }
}
