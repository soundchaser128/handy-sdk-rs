...
pub struct HampVelocityPercentResponse {
    #[serde(rename = "result")]
...
impl HampVelocityPercentResponse {
    pub fn new(result: models::GenericResult, velocity: f64) -> HampVelocityPercentResponse {
        HampVelocityPercentResponse { result, velocity }
    }
}
