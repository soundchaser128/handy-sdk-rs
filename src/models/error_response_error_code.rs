...
pub enum ErrorResponseErrorCode {
    /// The different possible general error codes.<p> <ul> <li>ERROR(1000) - Unspecified error</li> <li>DEVICE_TIMEOUT(1001) - A response from the device was not received within the maximum timeout.</li> <li>DEVICE_NOT_CONNECTED(1002) - The device is not connected.</li> </ul>
    Number(f64),
    BaseModeErrors(models::BaseModeErrors),
    HampModeErrors(models::HampModeErrors),
    HsspModeErrors(models::HsspModeErrors),
    HdspModeErrors(models::HdspModeErrors),
    MaintenanceModeErrors(models::MaintenanceModeErrors),
}

impl Default for ErrorResponseErrorCode {
    fn default() -> Self {
