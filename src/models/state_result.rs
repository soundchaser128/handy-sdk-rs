...
/// StateResult : Possible result codes returned from a HAMP start/stop operation.<ul><li>ERROR(-1) - Failed stop/starting motion.</li><li>SUCCESS_NEW_STATE(0) - Started/stopped motion.</li><li>SUCCESS_SAME_STATE(1) - Already started/stopped.</li></ul>
...
impl ToString for StateResult {
    fn to_string(&self) -> String {
        match self {
            Self::Error => String::from("-1"),
            Self::SuccessNewState => String::from("0"),
            Self::SuccessSameState => String::from("1"),
        }
    }
}

impl Default for StateResult {
    fn default() -> StateResult {
        Self::Error
    }
}
