...
/// HdspResult : Possible HDSP result codes. <ul><li>ERROR(-3) - Device failed processing the command.</li><li>SUCCESS_POSITION_REACHED(0)</li><li>SUCCESS_POSITION_NOT_REACHED(1)</li><li>SUCCES_ALREADY_AT_POSITION(2)</li><li>SUCCESS_INTERRTUPTED(3)</li></ul>
...
pub enum HdspResult {
    ...
    Error,
    #[serde(rename = "0")]
    SuccessPositionReached,
    #[serde(rename = "1")]
    SuccessPositionNotReached,
    #[serde(rename = "2")]
    SuccessAlreadyAtPosition,
    #[serde(rename = "3")]
    SuccessInterrupted,
}

impl ToString for HdspResult {
    fn to_string(&self) -> String {
        match self {
            Self::Error => String::from("-3"),
            Self::SuccessPositionReached => String::from("0"),
            Self::SuccessPositionNotReached => String::from("1"),
            Self::SuccessAlreadyAtPosition => String::from("2"),
            Self::SuccessInterrupted => String::from("3"),
        }
    }
}

impl Default for HdspResult {
    fn default() -> HdspResult {
        Self::Error
    }
}
