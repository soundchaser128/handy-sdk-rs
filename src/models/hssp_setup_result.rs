...
/// HsspSetupResult : Possible HSSP setup result codes. <ul><li>USING_CACHED(0) - Script already present on the device.</li><li>DOWNLOADED(1) - Script downloaded successfully.</li></ul>
...
impl ToString for HsspSetupResult {
    fn to_string(&self) -> String {
        match self {
            Self::UsingCached => String::from("0"),
            Self::Downloaded => String::from("1"),
        }
    }
}

impl Default for HsspSetupResult {
    fn default() -> HsspSetupResult {
        Self::UsingCached
    }
}
