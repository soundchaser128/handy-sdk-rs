...
#[serde(untagged)]
pub enum GetMode200Response {
    GetMode200ResponseOneOf(Box<models::GetMode200ResponseOneOf>),
    ErrorResponse(Box<models::ErrorResponse>),
}

impl Default for GetMode200Response {
    fn default() -> Self {
        Self::GetMode200ResponseOneOf(Default::default())
    }
}
