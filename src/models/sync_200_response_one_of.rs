...
pub struct Sync200ResponseOneOf {
    #[serde(rename = "result")]
    pub result: models::GenericResult,
    #[serde(rename = "time", skip_serializing_if = "Option::is_none")]
    pub time: Option<i32>,
    #[serde(rename = "rtd", skip_serializing_if = "Option::is_none")]
    pub rtd: Option<i32>,
}

impl Sync200ResponseOneOf {
    pub fn new(result: models::GenericResult) -> Sync200ResponseOneOf {
