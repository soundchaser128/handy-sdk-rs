...
pub struct SlideResultResponse {
    #[serde(rename = "result", skip_serializing_if = "Option::is_none")]
    pub result: Option<models::SlideResult>,
}

impl SlideResultResponse {
    pub fn new() -> SlideResultResponse {
        SlideResultResponse { result: None }
    }
}
