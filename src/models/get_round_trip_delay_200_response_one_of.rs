...
pub struct GetRoundTripDelay200ResponseOneOf {
    #[serde(rename = "result")]
    pub result: models::GenericResult,
    #[serde(rename = "rtd")]
    pub rtd: i32,
}

impl GetRoundTripDelay200ResponseOneOf {
    pub fn new(result: models::GenericResult, rtd: i32) -> GetRoundTripDelay200ResponseOneOf {
        GetRoundTripDelay200ResponseOneOf { result, rtd }
    }
}
