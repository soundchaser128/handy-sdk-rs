...
pub struct SlideUpdateResponse {
    #[serde(rename = "result")]
    pub result: models::SlideResult,
}

impl SlideUpdateResponse {
    pub fn new(result: models::SlideResult) -> SlideUpdateResponse {
        SlideUpdateResponse { result }
    }
}
