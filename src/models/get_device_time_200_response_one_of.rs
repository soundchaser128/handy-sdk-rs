...
pub struct GetDeviceTime200ResponseOneOf {
    #[serde(rename = "result")]
...
impl GetDeviceTime200ResponseOneOf {
    pub fn new(result: models::GenericResult, time: i32) -> GetDeviceTime200ResponseOneOf {
        GetDeviceTime200ResponseOneOf { result, time }
    }
}
