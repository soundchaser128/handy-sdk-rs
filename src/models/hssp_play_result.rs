...
/// HsspPlayResult : Possible HSSP play result codes. <ul><li>SUCCESS(0) - Script is playing.</li><li>ERROR(-1) - Script is not playing.</li></ul>
...
impl ToString for HsspPlayResult {
...
impl Default for HsspPlayResult {
    fn default() -> HsspPlayResult {
        Self::SUCCESS
    }
}
