...
impl ToString for HsspState {
    fn to_string(&self) -> String {
        match self {
            Self::NeedSync => String::from("1"),
            Self::NeedSetup => String::from("2"),
            Self::Stopped => String::from("3"),
            Self::Playing => String::from("4"),
        }
    }
}

impl Default for HsspState {
    fn default() -> HsspState {
        Self::NeedSync
    }
}
