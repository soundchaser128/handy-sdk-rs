...
/// MaintenanceModeErrors : The different possible MAINTENANCE mode specific error codes. <p> <ul> <li>ERROR(6000) - Unspecified MAINTENANCE error</li> <li>OPERATION_FAILED(6001) - The device failed to complete the MAINTENANCE operation successfully.</li> </ul>
...
pub enum MaintenanceModeErrors {
    #[serde(rename = "6000")]
    Error,
    #[serde(rename = "6001")]
    RestartFailed,
...
impl ToString for MaintenanceModeErrors {
    fn to_string(&self) -> String {
        match self {
            Self::Error => String::from("6000"),
            Self::RestartFailed => String::from("6001"),
        }
    }
}

impl Default for MaintenanceModeErrors {
    fn default() -> MaintenanceModeErrors {
        Self::Error
    }
}
